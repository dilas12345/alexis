      ...
      <View style={styles.findDriverContainer}>
        <View style={styles.contentTop}>
          <Label style={styles.text}>
            Connecting with nearby {bookingRecord.taxiType.type} Barber
          </Label>
        ...
        <View style={styles.contentBottom}>
          <Label style={styles.termsText}>By booking you confirm that you accept our Terms & Conditions</Label>
